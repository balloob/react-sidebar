...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSidebarEs6 = __webpack_require__(1);

	var _reactSidebarEs62 = _interopRequireDefault(_reactSidebarEs6);

	var _material_title_panelEs6 = __webpack_require__(2);

	var _material_title_panelEs62 = _interopRequireDefault(_material_title_panelEs6);
	...
	var App = _react2['default'].createClass({
	  ...
	  toggleDocked: function toggleDocked() {
	  ...
	  setContent: function setContent(content, ev) {
	    ev.preventDefault();

	    this.setState({ content: content });
	  },

	  createMenuLink: function createMenuLink(content) {
	    return _react2['default'].createElement(
	      'li',
	      { key: content },
	      _react2['default'].createElement(
	        'a',
	        { href: '#', onClick: this.setContent.bind(this, content) },
	        content
	      )
	    );
	  },
	  ...
	  render: function render() {
	    var sidebar = _react2['default'].createElement(
	      _material_title_panelEs62['default'],
	      { title: 'Menu', style: styles.sidebar },
	      ['Hello', 'World'].map(this.createMenuLink),
	      _react2['default'].createElement(
	        'div',
	        null,
	        'Open: ',
	    ...
	    return _react2['default'].createElement(
	      _reactSidebarEs62['default'],
	      { sidebar: sidebar, docked: this.state.docked,
	        open: this.state.open, toggleOpen: this.setOpen },
	      _react2['default'].createElement(
	        _material_title_panelEs62['default'],
	        { title: 'React Sidebar' },
	        _react2['default'].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactSidebar = (function (_React$Component) {
	  function ReactSidebar(props) {
	    ...
	    _get(Object.getPrototypeOf(ReactSidebar.prototype), 'constructor', this).call(this, props);
	  ...
	  _createClass(ReactSidebar, [{
	    ...
	    value: function touchStart(ev) {
	      ...
	      if (this.props.open) {
	        start = this.state.sidebarWidth;
	        end = this.state.sidebarWidth + this.props.touchDistance;
	        width = this.state.sidebarWidth;
	        modifier = posX - this.state.sidebarWidth;
	      } else {
	        start = 0;
	        end = this.props.touchDistance;
	        width = 0;
	        modifier = posX;
	      }

	      if (start < posX && posX < end) {
	        this.setState({
	          touching: true,
	          touchModifier: modifier,
	          touchSidebarWidth: width });
	      }
	    }
	  }, {
	    key: 'touchMove',
	    value: function touchMove(ev) {
	      if (this.state.touching) {
	        var posX = ev.targetTouches[0].clientX;

	        var newWidth = Math.min(this.state.sidebarWidth, Math.max(0, posX - this.state.touchModifier));

	        this.setState({ touchSidebarWidth: newWidth });
	      }
	    }
	  }, {
	    key: 'touchEnd',
	    value: function touchEnd(ev) {
	      if (this.state.touching) {
	        var shouldToggle = undefined;

	        if (this.props.open) {
	          // TODO don't use width/2 but allow setting via prop
	          shouldToggle = this.state.touchSidebarWidth < this.state.sidebarWidth - this.props.dragSidebarToggleDistance;
	        } else {
	          shouldToggle = this.state.touchSidebarWidth > this.props.dragSidebarToggleDistance;
	        }
	    ...
	    value: function componentDidMount() {
	      this.setState({
	        sidebarWidth: _reactAddons2['default'].findDOMNode(this.refs.sidebar).offsetWidth });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      if (this.state.touching) {
	        ...
	        sidebarStyle = update(sidebarStyle, { $merge: {
	            transform: 'translateX(' + (this.state.touchSidebarWidth - this.state.sidebarWidth) + 'px)',
	            transition: 'none' } });

	        var opacity = this.state.touchSidebarWidth / this.state.sidebarWidth;
	...
	ReactSidebar.propTypes = {
	  touchDistance: _reactAddons2['default'].PropTypes.number,
	  dragSidebarToggleDistance: _reactAddons2['default'].PropTypes.number,
	  docked: _reactAddons2['default'].PropTypes.bool,
	  open: _reactAddons2['default'].PropTypes.bool,
	  toggleOpen: _reactAddons2['default'].PropTypes.func };

	ReactSidebar.defaultProps = {
	  touchDistance: 20,
	  dragSidebarToggleDistance: 30,
	  docked: false,
	  open: false,
	  toggleOpen: function toggleOpen() {} };

	exports['default'] = ReactSidebar;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkedStateMixin = __webpack_require__(28);
	var React = __webpack_require__(5);
	var ReactComponentWithPureRenderMixin =
	  __webpack_require__(29);
	var ReactCSSTransitionGroup = __webpack_require__(30);
	...
	var cx = __webpack_require__(34);
	var cloneWithProps = __webpack_require__(35);
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(37);
	  React.addons.TestUtils = __webpack_require__(38);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMIframe = __webpack_require__(74);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var ReactTransitionChildMapping = __webpack_require__(105);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSProperty = __webpack_require__(155);
	var ExecutionEnvironment = __webpack_require__(27);
